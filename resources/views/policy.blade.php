...
<html>
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <nav id="nav">
                <ul>
                    <li><a class="buttons" onClick="document.getElementById('policy').innerHTML=document.getElementById('serviceTerms').innerHTML" style="color:gray;">Terms of Service</a></li>
                    <li><a class="buttons" onClick="document.getElementById('policy').innerHTML=document.getElementById('privacy').innerHTML" style="color:gray;">Privacy Policy</a></li>
                </ul>
            </nav>

            <!-- Main -->
            <div id="main">
                <div id="policy" style="overflow: auto;">
                    <center><h1>Addvise Terms of Service</h1></center>
            ...
            <div id="privacy" style="display: none; visibility: hidden;">
                ...
                <p>This document was last updated on August 25, 2017</p>
            </div>

            <div id="serviceTerms" style="display: none; visibility: hidden;">
                <center><h1>Addvise Terms of Service</h1></center>
