...
@section('title', 'Addvise Policies')
...
function getPrivacyPolicy() {
    document.getElementById('serviceTerms').style.display = "none";
    document.getElementById('serviceTerms').style.display = "hidden";
    document.getElementById('privacy').style.display = "inline";
...
function getTermsOfService() {
    ...
    document.getElementById('serviceTerms').style.display = "inline";
    document.getElementById('serviceTerms').style.display = "visible";
}
</script>
@stop
...
<nav id="nav">
<ul>
    <li><a class="buttons" onClick="getTermsOfService();">Terms of Service</a></li>
    <li><a class="buttons" onClick="getPrivacyPolicy();">Privacy Policy</a></li>
</ul>
</nav>
